export const products = [
    {
      ...
      price: 795,
      short_desription:'Phone X features an all-screen design with a 5.8-inch Super Retina HD display with HDR and True Tone...',
      ...
      short_description: 'Phone X features an all-screen design with a 5.8-inch Super Retina HD display with HDR and True Tone...',
    ...
    },
    {
      ...
      price: 618,
      short_description: 'This prism green Samsung Galaxy S10 Plus has a 6.4 inch Quad HD Infinity-O display so videos, shows ...',
    ...
    },
    {
      ...
      price: 299,
      short_description: 'iPhone 7 features an all-new 12-megapixel camera with an /1.8 aperture for great ...',
